...
in_flnms <- c("/Volumes/DATA/Project-3-Data/NT/ahi_NT_10_minute_Sept06to212015_20181024.csv",
...
type_df$cloud_mask_type <- group

type_df1 <- type_df
#type_df2 <- type_df[which(type_df$cloud_mask_type != "other"), ]

ggplot(data = type_df1, aes(x = date, y = n_pixels, fill = cloud_mask_type)) + 
  geom_bar(stat = 'identity') + ggtitle("ahi_NT_10_minute_Sept06to212015_20181024")
